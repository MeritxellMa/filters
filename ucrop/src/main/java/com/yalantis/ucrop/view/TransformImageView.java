 ...
 */
public class TransformImageView extends GLSurfaceView {
    ...
    public TransformImageView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs);
        Log.d("WARNING:", "TransformImageView amb defStyle cridat");
        //ORIGINAL: super(context, attrs, defStyle);
        init();
    }
...
/*original    @Override
    ...
    public void setImageBitmap(final Bitmap bitmap) {
        ...
        Log.d("WARNING:", "setImageBitmap assigned to GPUImage");
        //ORIGINAL: setImageDrawable(new FastBitmapDrawable(bitmap));
    }
    ...
    public Bitmap getViewBitmap() {
        Log.d("WARNING:", "getViewBitmap returns bitmap from GPUImage");
        if (mGPUImage.getBitmapWithFilterApplied() == null) {
            return null;
        } else {
            return mGPUImage.getBitmapWithFilterApplied();
        }
        /*ORIGINAL: if (getDrawable() == null || !(getDrawable() instanceof FastBitmapDrawable)) {
            return null;
        } else {
    ...
    protected void onImageLaidOut() {
        Log.d("WARNING:", "onImageLaidOut get bitmap from GPUImage");
        final Bitmap bitmap = mGPUImage.getBitmapWithFilterApplied();
        if (bitmap == null) {
            return;
        }
        /*ORIGINAL: final Drawable drawable = getDrawable();
        if (drawable == null) {
            return;
        }*/

        Log.d("WARNING:", "onImageLaidOut get bitmap bounds");
       ...
       /*ORIGINAL float w = drawable.getIntrinsicWidth();
